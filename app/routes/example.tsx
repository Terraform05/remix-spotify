export default function Example() {
  return (
    <div className="bg-white">
      ...
      <div className="mx-auto max-w-7xl py-12 sm:px-6 sm:py-12 lg:px-8" id="data_privacy">
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
      ...
      <div className="mx-auto max-w-7xl py-12 sm:px-6 sm:py-12 lg:px-8" id="meet_the_creator">
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <div className="mx-auto max-w-lg text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left ">
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Meet the creator.
